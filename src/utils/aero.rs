...
impl Aero {
    ...
    pub fn init() -> Self {
        Aero {
            path: "".to_string(),
            alpha: ndarray::Array1::zeros(0),
            mach: ndarray::Array1::zeros(0),
            cd_fit: ndarray::Array2::zeros((0, 0)),
            cna_fit: ndarray::Array2::zeros((0, 0)),
            cma_fit: ndarray::Array2::zeros((0, 0)),
            cmadcmq_fit: ndarray::Array1::zeros(0),
            cnpa_fit: ndarray::Array2::zeros((0, 0)),
            cllp_fit: ndarray::Array1::zeros(0),
            cd: ndarray::Array1::zeros(0),
            cna: ndarray::Array1::zeros(0),
            cma: ndarray::Array1::zeros(0),
            cnpa: ndarray::Array1::zeros(0),
            cmadcmq: 0.0,
            cllp: 0.0,
        }
    }
