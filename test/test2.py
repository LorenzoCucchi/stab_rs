import stab_rs.linear as linear
import stab_rs.stanag as stanag
...
simS = stanag.Simulation(geom,"coeffs.json",100.0,900.0,0.0,7.0,4.0,0.0,0.0,0.0,0.1)

print(simS.quad_elev)
simS.run()
